...
import problems.Strutture.SoluzioneTurni;
import problems.StruttureInterface;

public class BacktrackingTurni extends Backtracking{
	
	protected BacktrackingTurni(Object minVal) {
		super(minVal);
	}
	...
	protected boolean noMoreValues(Object x, StruttureInterface soluzione) {
		...
		System.out.println("Soluzione non è istanza di Strutture.SoluzioneTurni in noMoreValues");
		return true;
	}
	...
	protected boolean canAdd(Object x, StruttureInterface soluzione) {
		...
		System.out.println("Soluzione non è istanza di Strutture.SoluzioneTurni in canAdd");
		return false;
	}
	...
	protected void add(Object x, StruttureInterface soluzione) {
		...
		else System.out.println("Soluzione non è istanza di Strutture.SoluzioneTurni in add");
	}
	...
	protected boolean isComplete(StruttureInterface soluzione) {
		...
		System.out.println("Soluzione non è istanza di Strutture.SoluzioneTurni in isComplete");
		return false;
	}
